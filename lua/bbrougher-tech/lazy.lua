...
require("lazy").setup({
    ...
    },
    {
        ...
        keys = {
            { "<C-g>c",     "<cmd>GpChatNew popup<cr>",              mode = { "n", "i" },           desc = "Gp.nvim New Chat" },
            { "<C-g>t",     "<cmd>GpChatToggle popup<cr>",           mode = { "n", "i" },           desc = "Gp.nvim Toggle Chat" },
            { "<C-g>f",     "<cmd>GpChatFinder<cr>",           mode = { "n", "i" },           desc = "Chat Finder" },
            { "<C-g>c",     ":<C-u>'<,'>GpChatNew popup<cr>",        mode = "v",                    desc = "Visual Chat New" },
            { "<C-g>p",     ":<C-u>'<,'>GpChatPaste popup<cr>",      mode = "v",                    desc = "Visual Chat Paste" },
            { "<C-g>t",     ":<C-u>'<,'>GpChatToggle popup<cr>",     mode = "v",                    desc = "Visual Toggle Chat" },
